        ...
        <SafeAreaView className="flex-1 bg-white">
            <ScrollView className="px-6 mb-20">
                ...
                <Text className="text-lg font-inter text-black text-center mt-4 mb-8 leading-6">
                    U heeft altijd controle over wat u meldt en waar. Hierna wordt uw melding gelijk zichtbaar in het
                    overzicht.
                </Text>
            </ScrollView>
            ...
            <View className="absolute bottom-0 left-0 right-0 bg-[#558B71] h-[15%] justify-center items-center px-4">
                <Link href="/" asChild>
                    <TouchableOpacity
                        className="bg-white mb-2 px-6 py-3 rounded-full w-4/5 items-center shadow-md shadow-black/20">
